...
# Define ENUM types for idempotency
chat_session_status_enum = postgresql.ENUM('active', 'closed', name='chat_session_status_enum')
chat_message_type_enum = postgresql.ENUM('text', 'photo', 'video', 'voice', 'document', name='chat_message_type_enum')


def upgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    chat_session_status_enum.create(op.get_bind(), checkfirst=True)
