...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('active', 'closed', name='chat_session_status_enum'), nullable=False),
    ...
    sa.Column('message_type', sa.Enum('text', 'photo', 'video', 'voice', 'document', name='chat_message_type_enum'), nullable=False),
